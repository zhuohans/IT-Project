...
public enum ResponseEnum {
    ...
    UNPROCESSABLE_ENTITY(422, "unprocessable entity"),//unprocessable entity
    UNDEFINED_EXCEPTION(40000,"undefined error"),
    USERNAME_PASSWORD_EXCEPTION(40001,"user password incorrect"),
    USER_NOT_REGISTER_EXCEPTION(40002,"User not registered"),
