...
public final class RedisUtil {
    ...
    */
     ...
     * @return Time(s) Return 0 means it is permanently valid
     */
    ...
    /**
     * Delete the cache
     * @param key You can pass one value or multiple
     */
     ...
     * @param key
     * @param value
     * @param time  Time(s) time must be greater than 0. If time is less than or equal to 0, it will be set to indefinitely
     * @return true success
     */
     ...
     * Increment
     * @param key
     * @param delta To increase by a number (greater than 0)
     */
     ...
     * @param item
     * @param value
     * @param time Note: If the existing hash table has time, the original time will be replaced here
     * @return true
     */
     ...
     *
     * @param key
     * @param index When index>=0, 0 is the head of the table, 1 is the second element, and so on;
     *              when index<0, -1 is the tail of the table, -2 is the second to last element, and so on.
     */
